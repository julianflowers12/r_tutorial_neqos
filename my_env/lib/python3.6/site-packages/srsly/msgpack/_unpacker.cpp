...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "depends": [
            "/opt/hostedtoolcache/Python/3.8.8/x64/include/python3.8/Python.h",
            "/opt/hostedtoolcache/Python/3.8.8/x64/include/python3.8/pythread.h",
            "srsly/msgpack/unpack.h"
        ],
        "include_dirs": [
            "srsly/msgpack",
            "/opt/hostedtoolcache/Python/3.8.8/x64/include/python3.8",
            "."
        ],
        "language": "c++",
